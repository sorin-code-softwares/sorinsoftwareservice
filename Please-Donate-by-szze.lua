...
local Window = library:AddWindow("<3 // @szze x SorinSoftware Services Remake",
  {
...
local tierToggle = mainTab:AddSwitch('Use Donation Tiers', function(bool)
	...
	getgenv().settings.tierSystemEnabled = bool
	saveSettings()
end)
tierToggle:Set(getgenv().settings.tierSystemEnabled)
